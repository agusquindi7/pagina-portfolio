...
function FullStackPage({ projects, handleDelete, deletingId }) {
  ...
  return (
    <div>
      <Helmet>
              ...
              <meta name="description" content="Proyectos Full Stack de Agustín Quindimil" />
      </Helmet>
      <h2 style={{ textAlign: 'center' }}>Full Stack Projects</h2>
